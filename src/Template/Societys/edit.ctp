    ...
    <div class="widget-box">
      ...
      <?= $this->Form->create($society,['class'=>'form-horizontal']) ?>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <?=
              $this->Form->select('taux_comission', ['' => boucle100()]);?>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <?= $this->Form->input('password',['label'=>false , 'placeholder' => 'Mot de passe', 'value' => '']) ?>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <?= $this->Form->input('passwordconfirm',['label'=>false , 'placeholder' => 'Confirmer le mot de passe','type'=>'password','value' => '']) ?>
            </div>
          </div>
