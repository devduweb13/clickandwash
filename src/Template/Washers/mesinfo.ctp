...
?>
<?= $this->Form->create($infopreparateurs,['class'=>'form-horizontal']) ?>
<div class="row-fluid">
<div class="span6">
    <div class="widget-box">
      ...
      <div class="widget-content nopadding">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <?= $this->Form->input('nom',['label'=>false , 'placeholder' => 'Nom du point de vente','disabled' => 'disabled']) ?>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <?= $this->Form->input('adresse',['label'=>false , 'placeholder' => 'Adresse du point de vente' , 'disabled' => 'disabled']) ?>
            </div>
          </div>
          ...
          <div class="control-group">
            <label class="control-label">Code postal <span class="champ_requis"> * </span></label>
              <div class="controls">
              <?= $this->Form->input('cp',['label'=>false , 'placeholder' => 'Code postal du point de vente' , 'disabled' => 'disabled']) ?>
            </div>
          </div>
          ...
          <div class="control-group">
            <label class="control-label">Ville <span class="champ_requis"> * </span></label>
              <div class="controls">
              <?= $this->Form->input('ville',['label'=>false , 'placeholder' => 'Ville du point de vente' , 'disabled' => 'disabled']) ?>
            </div>
          </div>
